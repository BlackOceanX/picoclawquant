...
`web/` contains the standalone WebUI launcher for PicoClawQuant.
...
![PicoClawQuant Launcher](./picoclaw-launcher.png)
...
At runtime the launcher and the main PicoClawQuant engine are separate processes:
