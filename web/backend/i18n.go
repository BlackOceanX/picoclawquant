...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open PicoClawQuant console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About PicoClawQuant",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit PicoClawQuant",
		Exiting:            "Exiting PicoClawQuant...",
		DocUrl:             "https://docs.picoclaw.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 PicoClawQuant 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 PicoClawQuant",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 PicoClawQuant",
		Exiting:            "正在退出 PicoClawQuant...",
