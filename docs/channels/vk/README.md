...
2. Store the actual token using one of these methods:
   ...
   - **Secure storage**: Use PicoClawQuant's secure token storage mechanism
...
### 4. Configure PicoClawQuant

1. Add the token to your PicoClawQuant configuration
...
VK has a maximum message length of 4000 characters. PicoClawQuant automatically splits longer messages into multiple parts.
...
4. Check PicoClawQuant logs for error messages
