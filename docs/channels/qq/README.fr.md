...
PicoClawQuant prend en charge QQ via l'API Bot officielle de la plateforme ouverte QQ.
...
3. Renseigner les identifiants dans le fichier de configuration PicoClawQuant
...
4. Renseigner les identifiants dans le fichier de configuration PicoClawQuant
