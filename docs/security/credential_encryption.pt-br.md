...
O PicoClawQuant suporta a criptografia de valores `api_key` nas entradas de configuração `model_list`.
...
Se `PICOCLAW_SSH_KEY_PATH` não estiver definido, o PicoClawQuant procura a chave dedicada:
