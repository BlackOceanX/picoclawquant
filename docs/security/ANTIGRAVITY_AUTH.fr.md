...
10. [Créer un nouveau fournisseur dans PicoClawQuant](#créer-un-nouveau-fournisseur-dans-picoclaw)
...
- Go ≥ 1.25
- Base de code PicoClawQuant (`pkg/providers/` et `pkg/auth/`)
...
## Créer un nouveau fournisseur dans PicoClawQuant

Les fournisseurs PicoClawQuant sont implémentés en tant que packages Go sous `pkg/providers/`. Pour ajouter un nouveau fournisseur :
