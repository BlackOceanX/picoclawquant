...
<h1>PicoClawQuant: Pembantu AI Ultra-Cekap dalam Go</h1>

<h3>Perkakasan $10 · RAM 10MB · Boot ms · Jom, PicoClawQuant!</h3>
  <p>
...
> **PicoClawQuant** adalah projek sumber terbuka bebas yang dilancarkan oleh [Sipeed](https://sipeed.com), ditulis sepenuhnya dalam **Go** dari awal — bukan cabang OpenClaw, NanoBot, atau projek lain.

**PicoClawQuant** adalah pembantu AI peribadi ultra-ringan yang terinspirasi oleh [NanoBot](https://github.com/HKUDS/nanobot). Ia dibina semula dari awal dalam **Go** melalui proses "self-bootstrapping" — AI Agent itu sendiri yang memacu migrasi seni bina dan pengoptimuman kod.
...
> **Notis Keselamatan**
>
> * **TIADA KRIPTO:** PicoClawQuant **tidak** mengeluarkan sebarang token atau mata wang kripto rasmi. Semua tuntutan di `pump.fun` atau platform dagangan lain adalah **penipuan**.
...
> * **NOTA:** PicoClawQuant dalam pembangunan pesat awal. Mungkin terdapat isu keselamatan yang belum diselesaikan. Jangan deploy ke pengeluaran sebelum v1.0.
...
2026-05-11 🛒 **LicheeRV-Claw tersedia di AliExpress!** Anda kini boleh membeli LicheeRV-Claw di [AliExpress](https://www.aliexpress.com/item/1005006519668532.html), menjadikannya lebih mudah untuk mencuba PicoClawQuant pada perkakasan RISC-V yang kompak.
...
2026-03-31 📱 **Sokongan Android!** PicoClawQuant sekarang berjalan di Android! Muat turun APK di [picoclaw.io](https://picoclaw.io/download)

2026-03-25 🚀 **v0.2.4 Dikeluarkan!** Penstrukturan semula seni bina Agent (SubTurn, Hooks, Steering, EventBus), integrasi WeChat/WeCom, penguatan keselamatan (.security.yml, penapisan data sensitif), penyedia baharu (AWS Bedrock, Azure, Xiaomi MiMo), dan 35 pembetulan pepijat. PicoClawQuant mencapai **26K Stars**!

2026-03-17 🚀 **v0.2.3 Dikeluarkan!** UI dulang sistem (Windows & Linux), pertanyaan status sub-agent (`spawn_status`), muat semula panas Gateway eksperimental, kawalan keselamatan Cron, dan 2 pembetulan keselamatan. PicoClawQuant mencapai **25K Stars**!
...
2026-02-26 🎉 PicoClawQuant mencapai **20K Stars** hanya dalam 17 hari! Orkestrasi saluran automatik dan antara muka keupayaan kini aktif.

2026-02-16 🎉 PicoClawQuant melepasi 12K Stars dalam seminggu! Peranan penyelenggara komuniti dan [Peta Jalan](../../ROADMAP.md) dilancarkan secara rasmi.

2026-02-13 🎉 PicoClawQuant melepasi 5000 Stars dalam 4 hari! Peta jalan projek dan kumpulan pembangun sedang dalam proses.

2026-02-09 🎉 **PicoClawQuant Dikeluarkan!** Dibina dalam 1 hari untuk membawa AI Agent ke perkakasan $10 dengan RAM <10MB. Jom, PicoClawQuant!
...
<p align="center">
<img src="../../assets/hardware-banner.jpg" alt="Keserasian Perkakasan PicoClawQuant" width="100%">
</p>
...
PicoClawQuant boleh digunakan pada hampir mana-mana peranti Linux!
...
Muat turun binari untuk platform anda dari halaman [GitHub Releases](https://github.com/BlackOceanX/picoclawquant/releases).
...
Berikan telefon lama anda kehidupan baru! Jadikannya Pembantu AI pintar dengan PicoClawQuant.
...
<img src="../../assets/termux.jpg" alt="PicoClawQuant pada Termux" width="512">
...
PicoClawQuant menyokong 30+ penyedia LLM melalui konfigurasi `model_list`. Gunakan format `protokol/model`:
...
Bercakap dengan PicoClawQuant anda melalui 17+ platform pemesejan:
...
PicoClawQuant boleh mencari web untuk menyediakan maklumat terkini. Konfigurasikan dalam `tools.web`:
...
PicoClawQuant menyertakan alat terbina dalam untuk operasi fail, pelaksanaan kod, penjadualan, dan banyak lagi. Lihat [Konfigurasi Alat](../reference/tools_configuration.md) untuk butiran.
...
PicoClawQuant menyokong [MCP](https://modelcontextprotocol.io/) secara natif — sambungkan mana-mana pelayan MCP untuk melanjutkan keupayaan Agent anda dengan alat dan sumber data luaran.
...
Sambungkan PicoClawQuant ke Rangkaian Sosial Agent dengan menghantar satu mesej melalui CLI atau mana-mana Aplikasi Sembang yang disepadukan.
...
PicoClawQuant menyokong peringatan berjadual dan tugasan berulang melalui alat `cron`:
...
Lihat [Peta Jalan Komuniti](https://github.com/BlackOceanX/picoclawquant/issues/988) dan [CONTRIBUTING.md](../../CONTRIBUTING.md) untuk panduan.
