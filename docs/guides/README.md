...
Task-oriented guides for setup, configuration, and common PicoClawQuant workflows.

- [Docker & Quick Start Guide](docker.md): install and run PicoClawQuant with Docker or the launcher.
- [Android Termux Guide](android-termux.md): run the PicoClawQuant terminal binary on an ARM64 Android phone.
...
- [PicoClawQuant Hardware Compatibility List](hardware-compatibility.md): tested boards and platform notes.
- [Using Antigravity Provider in PicoClawQuant](ANTIGRAVITY_USAGE.md): Google Cloud Code Assist setup and usage.
