# Using Antigravity Provider in PicoClawQuant

This guide explains how to set up and use the **Antigravity** (Google Cloud Code Assist) provider in PicoClawQuant.
...
6.  **Paste it back into the terminal** where PicoClawQuant is waiting.

PicoClawQuant will extract the authorization code and complete the process automatically.
...
*   **429 Rate Limit**: Antigravity has strict quotas. PicoClawQuant will display the "reset time" in the error message if you hit a limit.
