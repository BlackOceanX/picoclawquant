...
# Usando o provedor Antigravity no PicoClawQuant

Este guia explica como configurar e usar o provedor **Antigravity** (Google Cloud Code Assist) no PicoClawQuant.
...
6.  **Cole-a de volta no terminal** onde o PicoClawQuant está aguardando.

O PicoClawQuant extrairá automaticamente o código de autorização e completará o processo.
...
*   **429 Limite de taxa**: O Antigravity possui cotas rigorosas. O PicoClawQuant exibirá o "tempo de redefinição" na mensagem de erro se você atingir um limite.
