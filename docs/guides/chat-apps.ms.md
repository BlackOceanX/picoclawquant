...
| **Pico**         | Protokol PicoClawQuant asli                     |
...
PicoClawQuant kini menyimpan definisi arahan dalam satu registry bersama. Semasa startup, Telegram akan mendaftarkan arahan bot yang disokong secara automatik (contohnya `/start`, `/help`, `/show`, `/list`, `/use`, `/btw`) supaya menu arahan dan tingkah laku runtime sentiasa selari.
...
Jika pendaftaran arahan gagal (ralat sementara rangkaian/API), saluran tetap akan bermula dan PicoClawQuant akan mencuba semula pendaftaran di latar belakang.
...
PicoClawQuant boleh menyambung ke WhatsApp dalam dua cara:
...
PicoClawQuant menyokong tiga jenis integrasi WeCom:
...
Mana-mana client MQTT boleh berkomunikasi dengan PicoClawQuant melalui broker. Peranti atau perkhidmatan menerbitkan permintaan ke broker; PicoClawQuant melanggan, memproses dan menerbitkan respons kembali.
