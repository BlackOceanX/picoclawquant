...
<h1>PicoClawQuant: Ultra-Efficient AI Assistant in Go</h1>

<h3>$10 Hardware · 10MB RAM · ms Boot · Let's Go, PicoClawQuant!</h3>
  <p>
...
> **PicoClawQuant** is an independent open-source project initiated by [Sipeed](https://sipeed.com), written entirely in **Go** from scratch — not a fork of OpenClaw, NanoBot, or any other project.

**PicoClawQuant** is an ultra-lightweight personal AI assistant inspired by [NanoBot](https://github.com/HKUDS/nanobot). It was rebuilt from the ground up in **Go** through a "self-bootstrapping" process — the AI Agent itself drove the architecture migration and code optimization.
...
> **Security Notice**
>
> * **NO CRYPTO:** PicoClawQuant has **not** issued any official tokens or cryptocurrency. All claims on `pump.fun` or other trading platforms are **scams**.
> * **OFFICIAL DOMAIN:** The **ONLY** official PicoClawQuant website is **[picoclaw.io](https://picoclaw.io)**, and company website is **[sipeed.com](https://sipeed.com)**
...
> * **NOTE:** PicoClawQuant is in early rapid development. There may be unresolved security issues. Do not deploy to production before v1.0.
> * **NOTE:** PicoClawQuant has recently merged many PRs. Recent builds may use 10-20MB RAM. Resource optimization is planned after feature stabilization.
...
2026-05-11 🛒 **LicheeRV-Claw on AliExpress!** You can now purchase LicheeRV-Claw from [AliExpress](https://www.aliexpress.com/item/1005006519668532.html), making it easier to try PicoClawQuant on compact RISC-V hardware.
...
2026-03-31 📱 **Android Support!** PicoClawQuant now runs on Android! Download the APK at [picoclaw.io](https://picoclaw.io/download)

2026-03-25 🚀 **v0.2.4 Released!** Agent architecture overhaul (SubTurn, Hooks, Steering, EventBus), WeChat/WeCom integration, security hardening (.security.yml, sensitive data filtering), new providers (AWS Bedrock, Azure, Xiaomi MiMo), and 35 bug fixes. PicoClawQuant has reached **26K Stars**!

2026-03-17 🚀 **v0.2.3 Released!** System tray UI (Windows & Linux), sub-agent status query (`spawn_status`), experimental Gateway hot-reload, Cron security gating, and 2 security fixes. PicoClawQuant has reached **25K Stars**!
...
2026-02-26 🎉 PicoClawQuant hits **20K Stars** in just 17 days! Channel auto-orchestration and capability interfaces are live.

2026-02-16 🎉 PicoClawQuant breaks 12K Stars in one week! Community maintainer roles and [Roadmap](ROADMAP.md) officially launched.

2026-02-13 🎉 PicoClawQuant breaks 5000 Stars in 4 days! Project roadmap and developer groups in progress.

2026-02-09 🎉 **PicoClawQuant Released!** Built in 1 day to bring AI Agents to $10 hardware with <10MB RAM. Let's Go, PicoClawQuant!
...
PicoClawQuant can be deployed on virtually any Linux device!
...
Alternatively, download the binary for your platform from the [GitHub Releases](https://github.com/BlackOceanX/picoclawquant/releases) page.
...
Give your decade-old phone a second life! Turn it into a smart AI Assistant with PicoClawQuant.
...
PicoClawQuant supports 30+ LLM providers through the `model_list` configuration. Use the `protocol/model` format:
...
Talk to your PicoClawQuant through 19+ messaging platforms:
...
PicoClawQuant can search the web to provide up-to-date information. Configure in `tools.web`:
...
PicoClawQuant includes built-in tools for file operations, code execution, scheduling, and more. See [Tools Configuration](docs/reference/tools_configuration.md) for details.
...
PicoClawQuant natively supports [MCP](https://modelcontextprotocol.io/) — connect any MCP server to extend your Agent's capabilities with external tools and data sources.
...
Connect PicoClawQuant to the Agent Social Network simply by sending a single message via the CLI or any integrated Chat App.
...
PicoClawQuant supports scheduled reminders and recurring tasks through the `cron` tool:
...
See our [Community Roadmap](https://github.com/BlackOceanX/picoclawquant/issues/988) and [CONTRIBUTING.md](CONTRIBUTING.md) for guidelines.
