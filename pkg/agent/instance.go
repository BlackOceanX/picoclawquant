...
import (
	...
	"github.com/BlackOceanX/picoclawquant/pkg/isolation"
	"github.com/BlackOceanX/picoclawquant/pkg/logger"
	"github.com/BlackOceanX/picoclawquant/pkg/media"
	"github.com/BlackOceanX/picoclawquant/pkg/memory"
...
func resolveAgentWorkspace(agentCfg *config.AgentConfig, defaults *config.AgentDefaults) string {
	...
	// Use the configured default workspace (respects PICOCLAWQUANT_HOME)
