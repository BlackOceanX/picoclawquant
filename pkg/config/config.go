...
import (
	...
	"github.com/BlackOceanX/picoclawquant/pkg/fileutil"
	"github.com/BlackOceanX/picoclawquant/pkg/logger"
	providercommon "github.com/BlackOceanX/picoclawquant/pkg/providers/common"
)
...
// IsolationConfig controls subprocess isolation for commands started by PicoClawQuant.
...
// email-based, end-to-end encrypted messenger; PicoClawQuant talks to a local
...
// only for legacy PicoClawQuant-managed email configuration.
