# PicoClawQuant Channel System：完整开发指南
...
import (
    "github.com/BlackOceanX/picoclawquant/pkg/bus"
    "github.com/BlackOceanX/picoclawquant/pkg/channels"     // 引用父包
    "github.com/BlackOceanX/picoclawquant/pkg/config"
    "github.com/BlackOceanX/picoclawquant/pkg/identity"      // 新增
    "github.com/BlackOceanX/picoclawquant/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "github.com/BlackOceanX/picoclawquant/pkg/channels/telegram"   // 触发 init() 注册
    _ "github.com/BlackOceanX/picoclawquant/pkg/channels/discord"
    _ "github.com/BlackOceanX/picoclawquant/pkg/channels/your_new_channel"  // 新增
)
```
...
4. **Pico Protocol**：`pkg/channels/pico/` 实现了一个自定义的 PicoClawQuant 原生协议 channel，通过 WebSocket webhook (`/pico/ws`) 接收消息。
