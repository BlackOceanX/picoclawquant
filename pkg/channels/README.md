# PicoClawQuant Channel System: Complete Development Guide
...
import (
    "github.com/BlackOceanX/picoclawquant/pkg/bus"
    "github.com/BlackOceanX/picoclawquant/pkg/channels"     // Reference parent package
    "github.com/BlackOceanX/picoclawquant/pkg/config"
    "github.com/BlackOceanX/picoclawquant/pkg/identity"      // New
    "github.com/BlackOceanX/picoclawquant/pkg/media"          // New (if media support needed)
)
```
...
import (
    _ "github.com/BlackOceanX/picoclawquant/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/BlackOceanX/picoclawquant/pkg/channels/discord"
    _ "github.com/BlackOceanX/picoclawquant/pkg/channels/your_new_channel"  // New addition
)
```
...
import (
    ...
    "github.com/BlackOceanX/picoclawquant/pkg/channels"
    "github.com/BlackOceanX/picoclawquant/pkg/config"
    "github.com/BlackOceanX/picoclawquant/pkg/identity"
...
// cmd/picoclaw/internal/gateway/helpers.go
import (
    _ "github.com/BlackOceanX/picoclawquant/pkg/channels/matrix"
)
```
...
4. **Pico Protocol**: `pkg/channels/pico/` implements a custom PicoClawQuant native protocol channel that receives messages via WebSocket webhook (`/pico/ws`).
