...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			repo:         "BlackOceanX/picoclawquant",
			wantOwner:    "sipeed",
		...
		},
		{
			...
			repo:         "BlackOceanX/picoclawquant/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "picoclaw",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/BlackOceanX/picoclawquant/tree/dev/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "picoclaw",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/BlackOceanX/picoclawquant/blob/main/README.md",
			wantOwner:    "sipeed",
			wantRepoName: "picoclaw",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/BlackOceanX/picoclawquant",
			wantOwner:    "sipeed",
			wantRepoName: "picoclaw",
			wantRef:      "main",
			wantSubPath:  "",
		...
		},
		{
			...
			repo:           "https://gitlab.com/BlackOceanX/picoclawquant/-/tree/main/skills/test",
			wantErr:        true,
...
func TestSkillInstaller_InstallFromGitHub_SkillAlreadyExists(t *testing.T) {
	...
	err = installer.InstallFromGitHub(context.Background(), "BlackOceanX/picoclawquant")
	if err == nil {
