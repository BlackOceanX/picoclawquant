...
import (
	...
	anthropicmessages "github.com/BlackOceanX/picoclawquant/pkg/providers/anthropic_messages"
	"github.com/BlackOceanX/picoclawquant/pkg/providers/azure"
	"github.com/BlackOceanX/picoclawquant/pkg/providers/bedrock"
	"github.com/BlackOceanX/picoclawquant/pkg/providers/common"
)
...
func CreateProviderFromConfig(cfg *config.ModelConfig) (LLMProvider, string, error) {
	...
	if userAgent == "" {
		userAgent = fmt.Sprintf("PicoClawQuant/%s", config.Version)
	}
